...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240611205017_TicketRelations")]
    partial class TicketRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Ticket", b =>
                {
                    b.HasOne("Domain.Models.EventExtendedModel", null)
                        .WithOne()
                        .HasForeignKey("Domain.Models.Ticket", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.Participant", null)
                        .WithOne()
                        .HasForeignKey("Domain.Models.Ticket", "ParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
