    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtendedEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExtendedEvents_EventsBase_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventExtendedModelId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Participants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Participants_ExtendedEvents_EventExtendedModelId",
                        column: x => x.EventExtendedModelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participants_EventExtendedModelId",
                table: "Participants",
                column: "EventExtendedModelId");
